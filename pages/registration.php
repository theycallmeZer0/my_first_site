...
<input type="text" class="form-control" name="name" id="name" placeholder="Имя"><br><br>
...
<input type="file" class="form-control" name="avatar" id="avatar" placeholder="Аватар"><br><br>
