...
<input type="text" method="request" class="form-control" name="login" id="login" placeholder="Логин" value="<?php echo $_SESSION['loginsave']; ?>"><br><br>
<input type="password" class="form-control" name="pass" id="pass" placeholder="Пароль" ><br><br>
<button id="butt" class="btn btn-success" type="submit" >Войти</button>
</form><a href="./registration.php" class="button"><h3> Зарегистрироваться </h3></a>
<div class = "msg">
                <p>
        <?php
